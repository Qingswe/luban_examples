...
lite是luban独有的数据格式，适合表达非常复杂嵌套的数据结构。lite格式是无字段名的格式，因此相比json和lua格式填写更为简洁，而且解析更高效。实践中建议 简单的复合数据使用流式格式，复杂的复合数据使用lite格式，仅在必要的情况下使用json和lua格式。详细文档见[lite格式](非excel数据源.md#lite%E6%A0%BC%E5%BC%8F)。
...
以json格式填写数据。详细文档见[json格式](非excel数据源.md#json%E6%A0%BC%E5%BC%8F)。
...
以lua格式填写数据。详细文档见[lua格式](非excel数据源.md#lua%E6%A0%BC%E5%BC%8F)。
