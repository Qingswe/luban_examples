...
> 来源: https://www.datable.cn/docs/beginner/integratetoproject
...
按[快速上手](快速上手.md)要求，安装[dotnet sdk 8.0](https://dotnet.microsoft.com/download/dotnet/8.0)。
