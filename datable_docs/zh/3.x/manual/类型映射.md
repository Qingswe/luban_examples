...
> 来源: https://www.datable.cn/docs/3.x/manual/typemapper
...
类型映射的定义方式请阅读文档[schema逻辑结构](schema 逻辑结构.md)及[配置定义](配置定义.md)。 由于类型映射影响了代码生成，目前**只有C#代码(cs-bin、cs-xxx-json之类)** 支持类型映射。如果其他语言也需要类型，请仿照修改即可。
