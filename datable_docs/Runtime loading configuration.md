...
Please connect Luban according to the [Connect Luban to Project](/en/docs/beginner/integratetoproject) document, and prepare the corresponding generation script gen.bat. If you have any questions, you can refer to the `gen.bat` file of the `Csharp_Unity_Json` project.
...
You can support asynchronous loading by modifying the [code template](/en/docs/manual/template).
