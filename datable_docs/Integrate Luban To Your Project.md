...
> 来源: https://www.datable.cn/en/docs/beginner/integratetoproject
...
Follow the [Quick Start](/en/docs/beginner/quickstart) requirements and install [dotnet sdk 8.0](https://dotnet.microsoft.com/download/dotnet/8.0).
...
Please see the next section [Load configuration at runtime](/en/docs/beginner/loadinruntime).
