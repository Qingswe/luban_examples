...
> 来源: https://www.datable.cn/en/docs/1.x/manual/generatecodedata
...
以luban_examples的DataTables配置为测试数据，以Projects下的csharp_Unity_bin和csharp_Unity_json项目为测试对比， 加载100遍cfg.Table。
