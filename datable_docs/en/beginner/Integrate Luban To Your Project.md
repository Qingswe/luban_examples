...
Follow the [Quick Start](Quick Start.md) requirements and install [dotnet sdk 8.0](https://dotnet.microsoft.com/download/dotnet/8.0).
...
Please see the next section [Load configuration at runtime](Runtime loading configuration.md).
