...
> 来源: https://www.datable.cn/en/docs/3.x/beginner/usecollection
...
For detailed definition documents, see [schema logical structure](../manual/schema logical structure.md) and [type system](../manual/type system.md), and for detailed data documents, see [Excel format (primary)](../manual/excel format (primary).md) and [Excel format (advanced)](../manual/excel format (advanced).md).

## Container definition​

Currently supports 4 basic container types, see [Container Type](../manual/type system.md#Container Type) for details:
...
You can even fill in multiple lines. As long as '*' is added before the field name, it means filling in multiple lines of data, one element per line. For details, see [Excel Format (Advanced)](../manual/excel format (advanced).md).
