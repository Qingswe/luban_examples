...
> 来源: https://www.datable.cn/en/docs/3.x/beginner/loadinruntime
...
Please connect Luban according to the [Connect Luban to Project](Add Luban To Your Project.md) document, and prepare the corresponding generation script gen.bat. If you have any questions, you can refer to the `gen.bat` file of the `Csharp_Unity_Json` project.
