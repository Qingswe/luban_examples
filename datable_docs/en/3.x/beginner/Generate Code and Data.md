...
> 来源: https://www.datable.cn/en/docs/3.x/beginner/generatecodeanddata
...
For more dataTarget, see [DataTarget List](../manual/Command line tools.md#data-target).
...
For more codeTargets, see [CodeTarget List](../manual/Command line tools.md#code-target).
