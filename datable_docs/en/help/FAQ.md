...
> 来源: https://www.datable.cn/en/docs/help/faq
...
Use a catalog data source. Put all json files in a directory (it can be a directory tree), and set input to this directory. luban will automatically traverse the entire directory tree, treating each file as A record is read in. For details, see [Other Data Sources-json](../manual/Non-Excel data source.md)

## Can a json file contain multiple records?​

Can. But it must be specified in the form of *@xxx.json in the data source. For details, see [Other Data Sources-json](../manual/Non-Excel data source.md)
...
For details, see [Other Data Sources-json](../manual/Non-Excel data source.md)

## Can the data of multiple tables be put into one json file like xlsx?​

Can. Similar to the excel data source, as long as each table is specified in the form of [field@xx.json](mailto:field@xx.json) or *[field@xx.json.](mailto:field@xx.json.) For details, see [Other Data Sources-json](../manual/Non-Excel data source.md)
