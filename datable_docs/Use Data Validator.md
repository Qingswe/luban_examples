...
For detailed documentation, see [Data Validator](/en/docs/manual/validator).
...
Please refer to the [data validator](/en/docs/manual/validator) document by yourself.
