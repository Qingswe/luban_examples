...
> 来源: https://www.datable.cn/en/docs/beginner/generatecodeanddata
...
For more dataTarget, see [DataTarget List](/en/docs/manual/commandtools#data-target).
...
For more codeTargets, see [CodeTarget List](/en/docs/manual/commandtools#code-target).
