...
For detailed definition documents, see [schema logical structure](/en/docs/manual/schema), and for detailed data documents, see [Excel format (beginner)](/en/docs/manual/excel) and [Excel format (advanced)](/en/docs/manual/exceladvanced).
...
For detailed explanation of the fields, see [enum logical structure](/en/docs/manual/schema#enum).
