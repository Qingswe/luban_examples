...
> 来源: https://www.datable.cn/en/docs/3.x/beginner/usevalidator
...
For detailed documentation, see [Data Validator](../manual/data validator.md).
...
![item](/en/assets/images/use_ref-b29587a7cf3f397ba36f8770a55e13d0.jpg)

## path validation​

Please refer to the [data validator](../manual/data validator.md) document by yourself.
