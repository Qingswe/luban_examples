...
> 来源: https://www.datable.cn/en/docs/3.x/beginner/usecustomtype
...
For detailed definition documents, see [schema logical structure](../manual/schema logical structure.md), and for detailed data documents, see [Excel format (beginner)](../manual/excel format (primary).md) and [Excel format (advanced)](../manual/excel format (advanced).md).
...
![color](/en/assets/images/define_color-9d8229fee2ca0814f9ddeee5188b8477.jpg)

For detailed explanation of the fields, see [enum logical structure](../manual/schema logical structure.md#enum).
...
![color](/en/assets/images/define_accessflag-d3d17a9c9b6042223d0fa32a63d8f238.jpg)
...
![enum data](/en/assets/images/enum-dee044226803effc6032313e7c4981e7.jpg)
...
![item](/en/assets/images/define_item-9f9e72ceb8af6dcbc0480a796fab3bd8.jpg)
...
![item](/en/assets/images/use_item-513b175faefd91435357a469108d961c.jpg)
...
![item](/en/assets/images/define_vec3-84c96a05193d45f68ef63cc0cc8fe5cb.jpg)
