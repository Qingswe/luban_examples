...
> 来源: https://www.datable.cn/en/docs/3.x/manual/schema
...
type| string| No| Field type, see [Type system](type system.md) for details  
comment| string| Yes| Comment  
...
variants| list,string| Yes| Field variants, see [Field variants](Field Variants.md) for details  
...
---|---|---|---  
name| string| No| field name  
type| string| No| Field type, see [type system](type system.md)  
comment| string| Yes| comment  
tags| map,string,string| custom tag pair|   
...
tags have two main purposes: [validator](data validator.md) and special code generation.
