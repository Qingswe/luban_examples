...
> 来源: https://www.datable.cn/en/docs/3.x/manual/dynamicbean
...
See the introduction of polymorphic types in [schema logical structure](schema logical structure.md).
