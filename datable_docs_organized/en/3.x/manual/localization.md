...
> 来源: https://www.datable.cn/en/docs/3.x/manual/l10n
...
The following types of localization are supported:
  ...
  * [Field variants](Field Variants.md). Configure a variant field for each localization target of the field, and only export the data of the specified variant when exporting
