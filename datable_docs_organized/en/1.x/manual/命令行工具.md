...
> 来源: https://www.datable.cn/en/docs/1.x/manual/commandtools
...
luban.server 运行在本机，端口为8899 luban.client的位置在 d:\tools\Luban.Client 配置定义在 d:\raw_config\defines 配置定义的根定义文件为 d:\raw_config\defines__root__.xml 配置数据在 d:\raw_configs\datas
