...
> 来源: https://www.datable.cn/docs/3.x/beginner/loadinruntime
...
请根据[接入Luban到项目](加入到项目.md)文档接入Luban，同时准备好相应的生成脚本gen.bat。如果有疑惑，可以参考 `Csharp_Unity_Json`项目的`gen.bat`文件。
...
你可以通过修改[代码模板](../manual/自定义模板.md)来支持异步加载。
